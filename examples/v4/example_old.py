...
comments = [
    ...
    Comment(user_name = 'g', text_content='검사 따위는 때려 치고말겠다!'),
    ...
    Comment(user_name = 'i', text_content='This is a complex sentence made up of several smaller sentences. This sentence should be divided in several different screens, as it clearly does not fit in one alone. So I hope this is long enough for this little test of ours'),
