...
def render_comment_list(
    ...
    with Progress(
        ...
        complete_pages_task = progress.add_task("Rendering video...", total=0, start=False, visible=False)
        composite_audio_task = progress.add_task("Rendering audio...", total=0, start=False, visible=False)
        composite_task = progress.add_task("Compositing...", total=0, start=False, visible=False)
        ...
        def on_ffmpeg_started():
            ...
            progress.update(composite_task, completed=0, total=1, refresh=True, visible=True)
        ...
        builder.render(comment_list, music_code, assigned_characters, adult_mode)
